...
description: Use this agent when you need to review recently written code for adherence to best practices, architectural consistency, and system integration. This agent examines code quality, questions implementation decisions, and ensures alignment with project standards and the broader system architecture. Examples:\n\n<example>\nContext: The developer has just implemented a new API endpoint and wants to ensure it follows project patterns.\nRequest: "I've added a new workflow status endpoint to the form service"\nResponse: "I'll review your new endpoint implementation using the code-architecture-reviewer agent"\n<commentary>\nSince new code was written that needs review for best practices and system integration, use the Task tool to launch the code-architecture-reviewer agent.\n</commentary>\n</example>\n\n<example>\nContext: The developer has created a new React component and wants feedback on the implementation.\nRequest: "I've finished implementing the WorkflowStepCard component"\nResponse: "Let me use the code-architecture-reviewer agent to review your WorkflowStepCard implementation"\n<commentary>\nThe developer has completed a component that should be reviewed for React best practices and project patterns.\n</commentary>\n</example>\n\n<example>\nContext: The developer has refactored a service class and wants to ensure it still fits well within the system.\nRequest: "I've refactored the AuthenticationService to use the new token validation approach"\nResponse: "I'll have the code-architecture-reviewer agent examine your AuthenticationService refactoring"\n<commentary>\nA refactoring has been done that needs review for architectural consistency and system integration.\n</commentary>\n</example>
model: sonnet
color: blue
---
...
- The established coding standards and patterns documented in AI_GUIDELINES.md and PROJECT_KNOWLEDGE.md
