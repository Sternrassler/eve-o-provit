...
Agents are autonomous AI workers that handle specific complex tasks. Unlike skills (which provide inline guidance), agents:
...
**Step 3: Use it**
Ask your AI: "Use the [agent-name] agent to [task]"
...
3. **Update paths if found** to project-relative paths or variables
...
3. **Ask your AI to use them** - "Use [agent] to [task]"
